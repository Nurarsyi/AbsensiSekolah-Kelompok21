...
$tglTerakhir = date('t',strtotime($tglBulan));
 ...
 <table width="100%">
 	<tr>
	 	<td>
 			<img src="../../../assets/img/SMK.png" width="130">
 		</td>
 		<td>
 			<center>
 				...
 				<h1>
 					ABSENSI SISWA <br>
 					<small>SMK 1 Tirtamulya</small>
 				</h1>
 				<hr>
 				<em>
				 Jl. Raya, Parakan, Kec. Tirtamulya, Karawang, Jawa Barat <br> Kabupaten Karawang, Provinsi Jawa Barat, Kode Pos (41372) <br>
 				<b>Email : Email : smkn1tirtamulya@gmail.com</b> 
 				</em>
  ...
  <tr>
    ...
    <td rowspan="5">
    	<ul>
    		...
    		<li>S = Sakit</li>
    		<li>I = Izin</li>
    		<li>A = Absen/Tanpa Keterangan</li>
	...
	<!-- 	<td align="left">
		...
		<td align="right">
			...
			<p>
				...
				<br>
				<br>
				Sugiat Bagja M.pd <br>
				----------------------<br>
				NIP.1967893615283454
			</p>
		</td>
	</tr>
</table>
